...
def setup_data(state,settings,geometry):
    """ SUAVE.Methods.Aerodynamics.AERODAS.setup_data(state,settings,geometry)
...
def lift_drag_total(state,settings,geometry):
    """ SUAVE.Methods.Aerodynamics.AERODAS.lift_drag_total(state,settings,geometry)
...
def lift_total(state,settings,geometry):
    """ SUAVE.Methods.Aerodynamics.AERODAS.lift_total(state,settings,geometry)
...
def drag_total(state,settings,geometry):
    """ SUAVE.Methods.Aerodynamics.AERODAS.drag_total(state,settings,geometry)
