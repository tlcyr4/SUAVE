...
class Settings(Data):
    """ SUAVE.Methods.Aerodynamics.AVL.Settings()
        Settings for running AVL: filenames and discretization settings
    """

    def __defaults__(self):
        """ SUAVE.Methods.Aerodynamics.AVL.Settings()
            Default settings for running AVL: filenames and discretization settings
        """
...
class AVL_Discretization_Settings(Data):
    """ SUAVE.Methods.Aerodynamics.AVL.Settings.AVL_Discretization_Settings()
        Settings for discretization in AVL
    """
    def __defaults__(self):
        """ SUAVE.Methods.Aerodynamics.AVL.Settings.AVL_Discretization_Settings.__defaults__()
        SPACING SCHEMES:
