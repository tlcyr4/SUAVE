...
def purge_directory(path,purge_subdirectories=False):
    """ SUAVE.Methods.Aerodynamics.AVL.purge_directory(path,purge_subdirectories=False)
        ...
        Inputs:
            path - path of directory to be purged
            purge_subdirectories - whether to recursively purge
    """
